...
import { localHistoryRoutes } from './routes/local-history';
...
import { remoteWorkspaceRoutes } from './routes/remote-workspace';
...
app.route('/api/local-history', localHistoryRoutes);
...
app.route('/api/remote-workspace', remoteWorkspaceRoutes);
