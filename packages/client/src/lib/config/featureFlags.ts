...
export const FEATURE_FLAGS = [
  ...
  },
  {
    ...
    label: 'Regex tester',
    description: 'Live match-tester on regex literals.',
    group: 'Inline widgets',
    issue: 'LYK-1099',
  },
  {
    ...
    label: 'Sparklines',
    description: 'Tiny charts next to numeric array literals.',
    group: 'Inline widgets',
    issue: 'LYK-1100',
  },
  {
    ...
    label: 'Media preview',
    description: 'Thumbnails for asset paths; inline SVG render.',
    group: 'Inline widgets',
    issue: 'LYK-1101',
  },
  {
